...
const Login = () => {
    ...
    <img src='/public/images/loe.png' />
        ...
        <Box mt={5}>
            <Box mt={3}>
            <TextField id="standard" placeholder="Username" fullWidth name='username' required/>
            </Box>

            <Box mt={3}>
            <TextField id="standard" placeholder="Password" type='password' fullWidth name='password' required/>
            </Box>

            <Box mt={3}>
            <Button name='submit' variant="contained" size="large" fullWidth className={classes.leo}>Login</Button>
            </Box>
